 ...
 */
public class ForgetMsgApi implements Api {
    private static final Logger LOG = LoggerFactory.getLogger(ForgetMsgApi.class);
    ...
    public JSONObject execute(JSONObject params) {
        ...
        try {
            ...
            String msg = "您正在忘记密码操作，验证码是:" + no  + "，30分钟内有效，请勿将验证码告诉他人，如非本人操作，请忽略。";
            //TODO 测试期间不发送短信
