/*
 * Copyright (C) 2008 Licensed under the Apache License, Version 2.0 (the
 ...
 * </p>
 */
public final class PTHttpClient implements HttpClient {
	/**
	 ...
	 */
	public static PTHttpClient newInstance(String userAgent) {
		...
		return new PTHttpClient(manager, params);
	}

	private final DefaultHttpClient delegate;

	private PTHttpClient(ClientConnectionManager ccm, HttpParams params) {
